...
class ControllerModuleTmGoogleMap extends Controller {
	public function index($setting) {
        ...
        if ($this->config->get('tm_google_map_sensor') == 1){
		    $this->document->addScript('//maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&sensor=true');
        }else{
            $this->document->addScript('//maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&sensor=false');
        }

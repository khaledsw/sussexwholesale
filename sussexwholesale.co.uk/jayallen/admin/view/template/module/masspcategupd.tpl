    ...
    <div class="panel panel-default"> <!-- filters div -->
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  ...
    	  <input type="submit" value="<?php echo $masstxt_filter_products_button; ?>" id="fil_prod_btn" name="lista_prod" class="btn btn-primary" style="width:222px; font-weight:bold;">
    	  <br /><br />

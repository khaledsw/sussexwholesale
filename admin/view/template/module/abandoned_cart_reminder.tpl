		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-acr-settings" class="form-horizontal">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab-setting">  
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-check-start-date"><span data-toggle="tooltip" data-html="true" title="<?php echo $help_check_start_date; ?>"><?php echo $entry_check_start_date; ?></span></label>
						<div class="col-sm-4">
							<div class="input-group date">
								<input type="text" name="abandoned_cart_reminder_check_start_date" value="<?php echo $abandoned_cart_reminder_check_start_date; ?>" placeholder="<?php echo $entry_check_start_date; ?>" data-date-format="YYYY-MM-DD" id="input-check-start-date" class="form-control" />
								<span class="input-group-btn">
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
								</span>
							</div>
							<?php if ($error_check_start_date) { ?>
							<div class="text-danger"><?php echo $error_check_start_date; ?></div>
							<?php } ?>
						</div> 
					</div>						

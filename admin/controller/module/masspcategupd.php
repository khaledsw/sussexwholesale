<?php 
class ControllerModulemasspcategupd extends Controller { 
	private $error = array();
	
	public function index() {

    		$this->load->language('module/masspcategupd');

		$this->document->addStyle('view/template/module/masspcategupd.css');
...
if ($this->user->hasPermission('modify', 'module/masspcategupd')) { /// modify permision
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		if (isset($this->session->data['success'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/masspcategupd', 'token=' . $this->session->data['token'], 'SSL')
   		);
		...
		$data['action'] = $this->url->link('module/masspcategupd', 'token=' . $this->session->data['token'], 'SSL');

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		
		$this->response->setOutput($this->load->view('module/masspcategupd.tpl', $data));
	}

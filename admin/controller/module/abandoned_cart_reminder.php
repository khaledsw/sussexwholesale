...
class ControllerModuleAbandonedCartReminder extends Controller {
	...
	public function index() {   
		...
		$data['entry_check_start_date'] = $this->language->get('entry_check_start_date');
		...
		$data['help_check_start_date'] = $this->language->get('help_check_start_date');
		...
		if (isset($this->error['check_start_date'])) {
			$data['error_check_start_date'] = $this->error['check_start_date'];
		} else {
			$data['error_check_start_date'] = '';
		}		
		...
		if (isset($this->request->post['abandoned_cart_reminder_check_start_date'])) {
			$data['abandoned_cart_reminder_check_start_date'] = $this->request->post['abandoned_cart_reminder_check_start_date'];
		} elseif ($this->config->get('abandoned_cart_reminder_check_start_date')) { 
			$data['abandoned_cart_reminder_check_start_date'] = $this->config->get('abandoned_cart_reminder_check_start_date');
		} else {
			$data['abandoned_cart_reminder_check_start_date'] = '';
		}		
	...
	private function validate() {
		...
		if ($dinamic_strlen($this->request->post['abandoned_cart_reminder_check_start_date']) < 1) {
			$this->error['check_start_date'] = $this->language->get('error_check_start_date');
			$this->error['warning'] = sprintf($this->language->get('error_in_tab'), $this->language->get('tab_setting'));
		}		
